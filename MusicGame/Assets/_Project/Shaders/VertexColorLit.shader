...
// MusicWorldManager) — no texture, no UV lookups, nothing that could desync from the mesh
// data. _AmbientFloor keeps shadowed areas from going pure black so the musical gradient
// stays readable there too (see GameplayConfig.terrainAmbientFloor).
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                return half4(IN.color.rgb * lightAmount, 1.0);
            }
            ENDHLSL
        }
